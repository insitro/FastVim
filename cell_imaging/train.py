...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_name", default="FastChannelVimS.yaml")
    parser.add_argument(
        "--model_save_dir", default="checkpoints_supervised_cellimaging/"
    )
    parser.add_argument("--checkpoint_every_n_epochs", default=50)
