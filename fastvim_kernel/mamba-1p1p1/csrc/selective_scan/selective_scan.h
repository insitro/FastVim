...
struct SSMParamsBase {
    ...
    index_t u_d_stride;
    index_t u_c_batch_stride;
    index_t u_c_d_stride;
...
struct SSMParamsBwd: public SSMParamsBase {
    ...
    index_t du_d_stride;
    index_t du_c_batch_stride;
    index_t du_c_d_stride;
