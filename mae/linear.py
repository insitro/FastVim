...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_name", default="linear_FastVimL.yaml")
    parser.add_argument("--model_save_dir", default="checkpoints_mae_linear_IN1k/")
    parser.add_argument("--checkpoint_every_n_epochs", default=90)
